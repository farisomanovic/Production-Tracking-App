/**
 * @file seedTestDatabase.js
 * @description The wipe-and-seed routine for the dedicated test database,
...
export async function seedTestDatabase() {
    ...
    return { operator, machine, parameter, machineParameter, product, material, recipe, templateRun }
}
